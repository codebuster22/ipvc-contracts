...
contract Warriors is ERC721 {
    ...
    mapping( uint256 => uint256 ) public warriors;
    uint256 warriorId;
    ...
    /**
     * @dev constructor
     * @param _controller of controller who is allowed to call write functions
     */
    ...
    /**
      ...
      */
    function generateWarrior(uint256 _gene, address _owner) public onlyController {
        require(
            _gene != 0,
